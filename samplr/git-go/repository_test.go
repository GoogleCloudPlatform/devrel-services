...
func TestDetectsNew(t *testing.T) {
	cases := []struct {
		...
		{Name: "Valid With Space", Str: "A	foo/bar baz.biz", Want: true, WantStr: "foo/bar baz.biz"},
...
func TestDetectsGone(t *testing.T) {
	cases := []struct {
		...
		{Name: "Valid With Space", Str: "D	foo/bar baz.biz", Want: true, WantStr: "foo/bar baz.biz"},
...
func TestDetectsModified(t *testing.T) {
	cases := []struct {
		...
		{Name: "Valid With Space", Str: "M	foo/bar baz.biz", Want: true, WantStr: "foo/bar baz.biz"},
...
func TestDetectsCopy(t *testing.T) {
	cases := []struct {
		...
		{Name: "Valid With Space", Str: "C100 foo/bar baz.biz\tfoo/bar.baz", Want: true, WantFrom: "foo/bar baz.biz", WantTo: "foo/bar.baz"},
		{Name: "Valid With Space End", Str: "C100 foo/bar.biz\tfoo/bar baz.biz", Want: true, WantFrom: "foo/bar.biz", WantTo: "foo/bar baz.biz"},
...
func TestDetectsRename(t *testing.T) {
	cases := []struct {
		...
		{Name: "Valid With Space", Str: "R100 foo/bar baz.biz\tfoo/bar.baz", Want: true, WantFrom: "foo/bar baz.biz", WantTo: "foo/bar.baz"},
		{Name: "Valid With Space End", Str: "R100 foo/bar.biz\tfoo/bar baz.biz", Want: true, WantFrom: "foo/bar.biz", WantTo: "foo/bar baz.biz"}, {Name: "Invalid", Str: "R	foo	bar", Want: false, WantFrom: "", WantTo: ""},
