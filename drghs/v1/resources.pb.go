...
type Responders_ContributorsType int32

const (
	Responders_WRITE Responders_ContributorsType = 0
	Responders_ADMIN Responders_ContributorsType = 1
	Responders_OWNER Responders_ContributorsType = 2
)

// Enum value maps for Responders_ContributorsType.
var (
	Responders_ContributorsType_name = map[int32]string{
		0: "WRITE",
		1: "ADMIN",
		2: "OWNER",
	}
	Responders_ContributorsType_value = map[string]int32{
		"WRITE": 0,
		"ADMIN": 1,
		"OWNER": 2,
	}
...
func (x Responders_ContributorsType) Enum() *Responders_ContributorsType {
	p := new(Responders_ContributorsType)
	*p = x
	return p
}

func (x Responders_ContributorsType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Responders_ContributorsType) Descriptor() protoreflect.EnumDescriptor {
	return file_resources_proto_enumTypes[2].Descriptor()
}

func (Responders_ContributorsType) Type() protoreflect.EnumType {
	return &file_resources_proto_enumTypes[2]
}

func (x Responders_ContributorsType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Responders_ContributorsType.Descriptor instead.
func (Responders_ContributorsType) EnumDescriptor() ([]byte, []int) {
...
type Responders struct {
	...
	Contributors Responders_ContributorsType `protobuf:"varint,2,opt,name=contributors,proto3,enum=drghs.v1.Responders_ContributorsType" json:"contributors,omitempty"`
	Users        []string                    `protobuf:"bytes,3,rep,name=users,proto3" json:"users,omitempty"`
}

func (x *Responders) Reset() {
	*x = Responders{}
	if protoimpl.UnsafeEnabled {
...
func (x *Responders) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Responders) ProtoMessage() {}

func (x *Responders) ProtoReflect() protoreflect.Message {
	mi := &file_resources_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Responders.ProtoReflect.Descriptor instead.
func (*Responders) Descriptor() ([]byte, []int) {
	return file_resources_proto_rawDescGZIP(), []int{11}
}

func (x *Responders) GetOwners() []string {
	if x != nil {
		return x.Owners
	}
	return nil
...
func (x *Responders) GetContributors() Responders_ContributorsType {
	if x != nil {
		return x.Contributors
	}
	return Responders_WRITE
}

func (x *Responders) GetUsers() []string {
	if x != nil {
		return x.Users
	}
	return nil
...
type SLO struct {
	...
	GitHubLabels         []string           `protobuf:"bytes,1,rep,name=gitHubLabels,proto3" json:"gitHubLabels,omitempty"`
	ExcludedGitHubLabels []string           `protobuf:"bytes,2,rep,name=excludedGitHubLabels,proto3" json:"excludedGitHubLabels,omitempty"`
	...
	Responders           *Responders        `protobuf:"bytes,8,opt,name=responders,proto3" json:"responders,omitempty"`
}
...
func (x *SLO) GetResponders() *Responders {
	if x != nil {
		return x.Responders
	}
	return nil
...
var file_resources_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_resources_proto_goTypes = []interface{}{
	...
	(Responders_ContributorsType)(0), // 2: drghs.v1.Responders.ContributorsType
	(*Repository)(nil),               // 3: drghs.v1.Repository
	(*GitCommit)(nil),                // 4: drghs.v1.GitCommit
	(*GitHubUser)(nil),               // 5: drghs.v1.GitHubUser
	(*GitHubComment)(nil),            // 6: drghs.v1.GitHubComment
	(*GitHubReview)(nil),             // 7: drghs.v1.GitHubReview
	(*Issue)(nil),                    // 8: drghs.v1.Issue
	(*File)(nil),                     // 9: drghs.v1.File
	(*SnippetVersionMeta)(nil),       // 10: drghs.v1.SnippetVersionMeta
	(*SnippetVersion)(nil),           // 11: drghs.v1.SnippetVersion
	(*Snippet)(nil),                  // 12: drghs.v1.Snippet
	(*Owner)(nil),                    // 13: drghs.v1.Owner
	(*Responders)(nil),               // 14: drghs.v1.Responders
	(*SLO)(nil),                      // 15: drghs.v1.SLO
	(*timestamp.Timestamp)(nil),      // 16: google.protobuf.Timestamp
	(*duration.Duration)(nil),        // 17: google.protobuf.Duration
}
var file_resources_proto_depIdxs = []int32{
	16, // 0: drghs.v1.GitCommit.authored_time:type_name -> google.protobuf.Timestamp
	16, // 1: drghs.v1.GitCommit.committed_time:type_name -> google.protobuf.Timestamp
	5,  // 2: drghs.v1.GitHubComment.user:type_name -> drghs.v1.GitHubUser
	16, // 3: drghs.v1.GitHubComment.created_at:type_name -> google.protobuf.Timestamp
	16, // 4: drghs.v1.GitHubComment.updated_at:type_name -> google.protobuf.Timestamp
	5,  // 5: drghs.v1.GitHubReview.actor:type_name -> drghs.v1.GitHubUser
	16, // 6: drghs.v1.GitHubReview.created_at:type_name -> google.protobuf.Timestamp
	...
	16, // 9: drghs.v1.Issue.created_at:type_name -> google.protobuf.Timestamp
	16, // 10: drghs.v1.Issue.updated_at:type_name -> google.protobuf.Timestamp
	16, // 11: drghs.v1.Issue.closed_at:type_name -> google.protobuf.Timestamp
	5,  // 12: drghs.v1.Issue.closed_by:type_name -> drghs.v1.GitHubUser
	4,  // 13: drghs.v1.Issue.git_commit:type_name -> drghs.v1.GitCommit
	5,  // 14: drghs.v1.Issue.assignees:type_name -> drghs.v1.GitHubUser
	5,  // 15: drghs.v1.Issue.reporter:type_name -> drghs.v1.GitHubUser
	6,  // 16: drghs.v1.Issue.comments:type_name -> drghs.v1.GitHubComment
	7,  // 17: drghs.v1.Issue.reviews:type_name -> drghs.v1.GitHubReview
	4,  // 18: drghs.v1.File.git_commit:type_name -> drghs.v1.GitCommit
	9,  // 19: drghs.v1.SnippetVersion.file:type_name -> drghs.v1.File
	10, // 20: drghs.v1.SnippetVersion.meta:type_name -> drghs.v1.SnippetVersionMeta
	11, // 21: drghs.v1.Snippet.primary:type_name -> drghs.v1.SnippetVersion
	2,  // 22: drghs.v1.Responders.contributors:type_name -> drghs.v1.Responders.ContributorsType
	17, // 23: drghs.v1.SLO.response_time:type_name -> google.protobuf.Duration
	17, // 24: drghs.v1.SLO.resolution_time:type_name -> google.protobuf.Duration
	14, // 25: drghs.v1.SLO.responders:type_name -> drghs.v1.Responders
